...
public class RangerTagSyncMetricsSourceTags extends RangerTagSyncMetricsSourceBase {
    ...
    private static final AtomicLong totalTimeEvents  = new AtomicLong(0L);
    private static final AtomicLong totalTimeUploads = new AtomicLong(0L);
