...
public enum RangerRemoteAuthzErrorCode implements RangerAuthzErrorCode {
    ...
    REMOTE_RESPONSE_INVALID(500, "00-004", "invalid response from Ranger PDP endpoint {0}"),
    REMOTE_CALL_UNSUCCESSFUL(502, "00-005", "Ranger PDP endpoint {0} returned HTTP {1}: {2}"),
    MISSING_AUTH_CONFIG(500, "00-006", "missing property {0}"),
    UNSUPPORTED_AUTH_TYPE(500, "00-007", "unsupported auth type {0}"),
    TLS_CONFIGURATION_FAILED(500, "00-008", "failed to initialize TLS for Ranger PDP endpoint {0}"),
    KERBEROS_LOGIN_FAILED(500, "00-009", "failed to initialize Kerberos credentials for Ranger PDP endpoint {0}");
