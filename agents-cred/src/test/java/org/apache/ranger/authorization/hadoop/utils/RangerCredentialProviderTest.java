...
public class RangerCredentialProviderTest {
    ...
    public RangerCredentialProviderTest() throws IOException {
        ...
        String keystoreFile = ksFile.toURI().getPath();
    ...
    public void testCredentialProvider() {
        ...
        if (providers != null) {
            assertEquals(url, providers.get(0).toString());
        }
    ...
    public void testCredentialString() {
        ...
        if (providers != null) {
            assertEquals("PassworD123", cp.getCredentialString(url, "TestCredential001"));
        }
