...
public class HIVERangerAuthorizerTest {
    ...
    public static void setup() throws Exception {
        ...
        conf.set(HiveConf.getConfVars("javax.jdo.option.ConnectionURL").varname, String.format("jdbc:derby:;databaseName=%s;create=true", metastoreDir.getPath()));
        ...
        conf.set(HiveConf.ConfVars.HIVE_AUTHORIZATION_MANAGER.varname, "org.apache.ranger.authorization.hive.authorizer.RangerHiveAuthorizerFactory");
    }
    ...
    public void testTagBasedPolicyForTable() throws Exception {
        String     url        = "jdbc:hive2://localhost:" + port;
        Connection connection = DriverManager.getConnection(url, "admin", "admin"); // Create a database as "admin"
        Statement  statement  = connection.createStatement();
        ...
        final String tableUrl = "jdbc:hive2://localhost:" + port + "/hivetable"; // Create a "words" table in "hivetable"
        ...
        ugi.doAs((PrivilegedExceptionAction<Void>) () -> {
            Connection connection1 = DriverManager.getConnection(tableUrl, "alice", "alice");
            Statement  statement1  = connection1.createStatement();

            // "words" should work
            ResultSet resultSet = statement1.executeQuery("SELECT * FROM words");
            ...
            try {
                // "words2" should not
                statement1.executeQuery("SELECT * FROM words2");
    ...
    public void testTagBasedPolicyForColumn() throws Exception {
        ...
        ugi.doAs((PrivilegedExceptionAction<Void>) () -> {
            Connection connection1 = DriverManager.getConnection(tableUrl, "frank", "frank");

            // we can select "word" from "words"
            Statement statement1 = connection1.createStatement();
            ResultSet resultSet  = statement1.executeQuery("SELECT word FROM words");
            ...
            try {
                ...
                statement1.executeQuery("SELECT word FROM words2");
                Assertions.fail("Failure expected on an unauthorized call");
            } catch (SQLException ex) {
                // expected
            }
