...
import org.apache.ranger.audit.consumer.AuditServerConstants;
...
public class AuditMessageQueueUtils {
    ...
    public String getJAASConfig(Properties props, String propPrefix) {
        ...
        try {
            principal = SecureClientLogin.getPrincipal(props.getProperty(propPrefix + "." + AuditServerConstants.PROP_AUDIT_SERVICE_PRINCIPAL), hostName);
