...
public class HdfsConsumerApplication {
    ...
    private static final String APP_NAME      = "audit-consumer-hdfs";
    private static final String CONFIG_PREFIX = "ranger.audit.consumer.";
    ...
    public static void main(String[] args) {
        ...
        try {
            // Load configuration (includes core-site.xml, hdfs-site.xml, ranger-audit-consumer-site.xml, and ranger-audit-consumer-hdfs-site.xml)
