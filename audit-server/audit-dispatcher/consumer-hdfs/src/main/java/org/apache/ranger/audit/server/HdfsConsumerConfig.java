...
public class HdfsConsumerConfig extends AuditConfig {
    ...
    private static final    String             COMMON_CONFIG_FILE_PATH = "conf/ranger-audit-consumer-site.xml";
    private static final    String             HDFS_CONFIG_FILE_PATH   = "conf/ranger-audit-consumer-hdfs-site.xml";
