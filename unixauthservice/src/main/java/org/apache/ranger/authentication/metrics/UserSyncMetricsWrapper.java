...
public class UserSyncMetricsWrapper {
    ...
    public void init() {
        ...
        sourceWrappers.add(new RangerMetricsSourceWrapper("UserSyncSource", "Ranger UserSync metrics", context, rangerUserSyncSourceApis));

        sourceWrappers.add(new RangerMetricsSourceWrapper("UserSyncSourceCache", "Ranger UserSync Cache metrics", context, rangerUserSyncSourceCache));

        sourceWrappers.add(new RangerMetricsSourceWrapper("UserSyncSourceSyncSource", "Ranger UserSync Sync Source metrics", context, rangerUserSyncSourceSyncSource));

        sourceWrappers.add(new RangerMetricsSourceWrapper("UserSyncSourceCommon", "Ranger UserSync Role Status metrics", context, rangerUserSyncSourceRoleStatus));
