...
@Component
public class PatchForOzoneServiceDefUpdate_J10066 extends BaseLoader {
    private static final Logger logger = LoggerFactory.getLogger(PatchForOzoneServiceDefUpdate_J10066.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            PatchForOzoneServiceDefUpdate_J10066 loader = (PatchForOzoneServiceDefUpdate_J10066) CLIUtil.getBean(PatchForOzoneServiceDefUpdate_J10066.class);
    ...
    public void printStats() {
        logger.info("PatchForOzoneServiceDefUpdate_J10066 data ");
    }
    ...
    private boolean updateOzoneServiceDef() throws Exception {
        logger.info("==> PatchForOzoneServiceDefUpdate_J10066.updateOzoneServiceDef()");
