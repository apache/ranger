...
public class PatchForHBaseServiceDefUpdate_J10035 extends BaseLoader {
    ...
    private boolean updateHBaseServiceDef() throws Exception {
        RangerServiceDef embeddedHBasServiceDef = EmbeddedServiceDefsUtil.instance().getEmbeddedServiceDef(SERVICEDBSTORE_SERVICEDEFBYNAME_HBASE_NAME);

        if (embeddedHBasServiceDef != null) {
            XXServiceDef xXServiceDefObj = daoMgr.getXXServiceDef().findByName(SERVICEDBSTORE_SERVICEDEFBYNAME_HBASE_NAME);
            ...
            RangerServiceDef    dbHBaseServiceDef          = svcDBStore.getServiceDefByName(SERVICEDBSTORE_SERVICEDEFBYNAME_HBASE_NAME);

            if (dbHBaseServiceDef != null) {
                List<RangerServiceDef.RangerAccessTypeDef> embeddedHBaseAccessTypes = embeddedHBasServiceDef.getAccessTypes();
            ...
            RangerServiceDef ret = svcStore.updateServiceDef(dbHBaseServiceDef);
