...
public class RangerAuditMetricsListByDays extends VList {
    ...
    public RangerAuditMetricsListByDays(List<RangerAuditMetricsByDays> objList) {
        super(objList);
    ...
    public void setAuditMetricsListByDays(List<RangerAuditMetricsByDays> auditMetricsByDays) {
