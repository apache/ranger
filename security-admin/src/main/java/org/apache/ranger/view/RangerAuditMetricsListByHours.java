...
public class RangerAuditMetricsListByHours extends VList {
    ...
    List<RangerAuditMetricsByHours> auditMetricsByHours = new ArrayList<>();

    public RangerAuditMetricsListByHours() {
        super();
    }

    public RangerAuditMetricsListByHours(List<RangerAuditMetricsByHours> objList) {
        super(objList);
        this.auditMetricsByHours = objList;
    }

    public List<RangerAuditMetricsByHours> getAuditMetricsListByHours() {
        return auditMetricsByHours;
    }

    public void setAuditMetricsListByHours(List<RangerAuditMetricsByHours> auditMetricsByHours) {
