...
public class XXAuthSession extends XXDBBase implements java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.authStatus != other.authStatus) {
            return false;
        }
        if (this.authType != other.authType) {
            return false;
        }
        if (this.authProvider != other.authProvider) {
            return false;
        }
        ...
        return (this.requestUserAgent != null || other.requestUserAgent == null) && (this.requestUserAgent == null || this.requestUserAgent.equals(other.requestUserAgent));
    }
