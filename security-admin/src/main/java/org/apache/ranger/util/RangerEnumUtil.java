...
public class RangerEnumUtil {
    ...
    public String getLabel(String enumName, int enumValue) {
        ...
        logger.error("Enum value not found. enum=" + enumName + ", value=" + enumValue, new Throwable());
        return "";
    }
    ...
    public int getValue(String enumName, String elementName) {
        ...
        logger.error("Enum value not found. enum=" + enumName + ", elementName=" + elementName, new Throwable());
        return -1;
    }
