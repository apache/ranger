...
public abstract class RangerRoleServiceBase<T extends XXRole, V extends RangerRole> extends RangerAuditedModelService<T, V> {
    public RangerRoleServiceBase() {
        ...
        searchFields.add(new SearchField(SearchFilter.ASSOCIATED_ROLE_NAME_PARTIAL, "xXRoleRefRole.subRoleName", SearchField.DATA_TYPE.STRING, SearchField.SEARCH_TYPE.PARTIAL, "XXRoleRefRole xXRoleRefRole", "xXRoleRefRole.roleId = obj.id"));
