...
public class RangerGdsDatasetService extends RangerGdsBaseModelService<XXGdsDataset, RangerDataset> {
    ...
    public RangerGdsDatasetService() {
        ...
        searchFields.add(new SearchField(SearchFilter.DATA_SHARE_NAME, "ds.name",           SearchField.DATA_TYPE.STRING,  SearchField.SEARCH_TYPE.FULL, "XXGdsDataShareInDataset dshid, XXGdsDataShare dsh", "obj.id = dshid.datasetId and dshid.dataShareId = dsh.id"));
