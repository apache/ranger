...
define(function(require){
	...
	/**
	 * Gets the ranger configuration  manager
	 *
	...
	RangerConfigMgr.getRangerManagementConfig = function() {
		...
		rangerManagementConfig = new RangerManagementConfig();
		rangerManagementConfig.getRangerManagementConfig({async : false,cache:false}).done(function(data){
			rangerManagementConfig.set(data);
		});
		return rangerManagementConfig;
	};
