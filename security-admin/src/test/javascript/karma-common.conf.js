...
module.exports = function(config, appJsLoader, jssrc) {
  return {

    //make the source folder location available to the browser:
    client: {
      jssrc: jssrc
    },
    ...
    files: [
      ...
      {pattern: jssrc + '/scripts/**', included: false},
      {pattern: jssrc + '/templates/**', included: false},
      {pattern: 'src/test/javascript/tests/**', included: false},
    ],
