...
public class TestRangerAdminMetricsSourcePolicyRowFiltering {
    ...
    public void testRefresh_WithValidMetrics() {
        RangerAdminMetricsSourcePolicyRowFiltering spyRowFilteringSource = spy(rowFilteringSource);
        ...
        verify(spyRowFilteringSource).addMetricEntries(EXPECTED_METRIC_PREFIX, mockMetrics);
    ...
    public void testRefresh_WithEmptyMetrics() {
        ...
        verify(spyRowFilteringSource).addMetricEntries(EXPECTED_METRIC_PREFIX, emptyMetrics);
        verify(rangerMetricsFetcher).getPolicyMetrics(RangerPolicy.POLICY_TYPE_ROWFILTER);
    }
