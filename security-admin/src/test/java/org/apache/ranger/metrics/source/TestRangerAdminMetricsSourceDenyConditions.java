...
public class TestRangerAdminMetricsSourceDenyConditions {
    ...
    public void testRefresh_WithValidMetrics() {
        RangerAdminMetricsSourceDenyConditions spyDenyConditionsSource = spy(denyConditionsSource);
        ...
        verify(spyDenyConditionsSource).addMetricEntries(EXPECTED_METRIC_PREFIX, mockMetrics);
    ...
    public void testRefresh_WithEmptyMetrics() {
        ...
        verify(spyDenyConditionsSource).addMetricEntries(EXPECTED_METRIC_PREFIX, emptyMetrics);
        verify(rangerMetricsFetcher).getDenyConditionsMetrics();
    }
