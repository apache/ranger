...
public class TestRangerJAXBContextResolver {
    ...
    public void setUp() {
        try {
            ...
            Assumptions.assumeTrue(false, "Skipping JAXB resolver tests: JAXB runtime not present (" + t.getClass().getSimpleName() + ")");
        }
    }
    ...
    public void testConstructorInitializesContext() {
        try {
            ...
            Assumptions.assumeTrue(false, "Skipping: JAXB runtime not present");
        }
    }
