...
/**
 * @generated by Cursor
 * @description : Unit Test cases for RangerConfigUtil
 */
...
public class TestRangerConfigUtil {
    ...
    public void testGetDefaultMaxRows() {
        ...
        assertEquals(maxRow, xaConfigUtil.defaultMaxRows);
    }
    ...
    public void testGetWebAppRootURL() {
        ...
        assertEquals(returnValue, xaConfigUtil.webappRootURL);
    }

    @Test
    public void testGetRoles() {
        String[] str = xaConfigUtil.getRoles();
        assertArrayEquals(str, xaConfigUtil.roles);
    }
}
