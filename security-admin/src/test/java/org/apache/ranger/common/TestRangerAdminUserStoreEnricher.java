...
public class TestRangerAdminUserStoreEnricher {
    ...
    public void testEnrichRefreshesUserStoreWhenVersionDiffers() {
        ...
        Assert.assertNotNull(storeInContext);
        Assert.assertEquals(Long.valueOf(2L), storeInContext.getUserStoreVersion());
        Assert.assertEquals(Long.valueOf(2L), enricher.getUserStoreVersion());
    }
    ...
    public void testEnrichDoesNotRefreshWhenVersionIsSame() {
        ...
        Assert.assertSame(storeInContext, existingStore);
    }
}
