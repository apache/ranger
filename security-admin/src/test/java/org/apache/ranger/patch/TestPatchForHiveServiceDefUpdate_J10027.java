...
/**
 * @generated by Cursor
 * @description <Unit Test for PatchForHiveServiceDefUpdate_J10027 class>
 */
@ExtendWith(MockitoExtension.class)
@TestMethodOrder(MethodOrderer.MethodName.class)
public class TestPatchForHiveServiceDefUpdate_J10027 {
    ...
    public void testExecLoadAndPrintStats() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            ...
            PatchForHiveServiceDefUpdate_J10027 patch = new PatchForHiveServiceDefUpdate_J10027();
    ...
    @Test
    public void testUpdateHiveServiceDef_embeddedNull_returnsFalse() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
            ...
            PatchForHiveServiceDefUpdate_J10027 patch = new PatchForHiveServiceDefUpdate_J10027();
            Method m = PatchForHiveServiceDefUpdate_J10027.class.getDeclaredMethod("updateHiveServiceDef");
    ...
    @Test
    public void testUpdateHiveServiceDef_daoNull_returnsTrue() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
    ...
    @Test
    public void testUpdateHiveServiceDef_dbNull_returnsFalse() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
            RangerServiceDef embedded = new RangerServiceDef();
    ...
    @Test
    public void testUpdateHiveServiceDef_happyPath_andOptionsRestore() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
            ...
            RangerServiceDef.RangerAccessTypeDef refresh = new RangerServiceDef.RangerAccessTypeDef();
    ...
    public void testJsonStringToMap_legacyAndJson() throws Exception {
        PatchForHiveServiceDefUpdate_J10027 patch = new PatchForHiveServiceDefUpdate_J10027();
        setIfPresent(patch, "jsonUtil", new JSONUtil());
        Method m = PatchForHiveServiceDefUpdate_J10027.class.getDeclaredMethod("jsonStringToMap", String.class);
        m.setAccessible(true);
    ...
    @Test
    public void testUpdateHiveServiceDef_retNull_throws() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
    ...
    @Test
    public void testUpdateHiveServiceDef_postDaoMissing_returnsFalse() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
            ...
            XXServiceDef xxPre = new XXServiceDef();
            xxPre.setDefOptions(new JSONUtil().readMapToString(new HashMap<String, String>()));
    ...
    @Test
    public void testUpdateHiveServiceDef_optionRestore_removeWhenPreMissing() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
    ...
    @Test
    public void testCheckNewHiveAccessTypesPresent_trueFalse() throws Exception {
        Method m = PatchForHiveServiceDefUpdate_J10027.class.getDeclaredMethod("checkNewHiveAccessTypesPresent",
                List.class);
        m.setAccessible(true);
        ...
        a.setName("select");
        list.add(a);
        Assertions.assertFalse((boolean) m.invoke(null, list));
        RangerServiceDef.RangerAccessTypeDef b = new RangerServiceDef.RangerAccessTypeDef();
        b.setName("refresh");
        list.add(b);
        Assertions.assertTrue((boolean) m.invoke(null, list));
    }
}
