...
public class TestPatchForAtlasNotificationTopic_J10067 {
    ...
    public void testExecLoadAndPrintStats() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            ...
            PatchForAtlasNotificationTopic_J10067 patch = new PatchForAtlasNotificationTopic_J10067();
    ...
    public void testMain_Success_ExitZero() {
        ...
        try (MockedStatic<CLIUtil> cliMock = Mockito.mockStatic(CLIUtil.class)) {
            ...
            cliMock.when(() -> CLIUtil.getBean(PatchForAtlasNotificationTopic_J10067.class)).thenReturn(patch);
            ...
            try {
                PatchForAtlasNotificationTopic_J10067.main(new String[] {});
    ...
    public void testMain_Failure_ExitOne() {
        SecurityManager originalSm = System.getSecurityManager();
        try (MockedStatic<CLIUtil> cliMock = Mockito.mockStatic(CLIUtil.class)) {
            cliMock.when(() -> CLIUtil.getBean(PatchForAtlasNotificationTopic_J10067.class)).thenThrow(new RuntimeException("boom"));
    ...
    @Test
    public void testAddNotificationTopicPermissionInServiceDef_ServiceDefNotFound_ReturnsEarly() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            EmbeddedServiceDefsUtil util = Mockito.mock(EmbeddedServiceDefsUtil.class);
            utilMock.when(EmbeddedServiceDefsUtil::instance).thenReturn(util);
    ...
    public void testExecLoad_UpdateReturnsNull_ThrowsRuntime() throws Exception {
        try (MockedStatic<EmbeddedServiceDefsUtil> utilMock = Mockito.mockStatic(EmbeddedServiceDefsUtil.class)) {
            ...
            res.setName("notification-topic");
            embeddedAtlas.setResources(new ArrayList<>(Collections.singletonList(res)));
            embeddedAtlas.setAccessTypes(new ArrayList<>(Collections.singletonList(new RangerServiceDef.RangerAccessTypeDef("post-notification"))));
    ...
    public void testPrivate_Checkers() throws Exception {
        PatchForAtlasNotificationTopic_J10067 patch = new PatchForAtlasNotificationTopic_J10067();
        Method cr = PatchForAtlasNotificationTopic_J10067.class.getDeclaredMethod("checkResourcePresent", List.class);
        Method ca = PatchForAtlasNotificationTopic_J10067.class.getDeclaredMethod("checkAccessPresent", List.class);
        cr.setAccessible(true);
        ca.setAccessible(true);

        RangerServiceDef.RangerResourceDef r = new RangerServiceDef.RangerResourceDef();
        r.setName("notification-topic");
        List<RangerServiceDef.RangerResourceDef> rList = new ArrayList<>();
        rList.add(r);
        Assertions.assertTrue((Boolean) cr.invoke(patch, rList));

        RangerServiceDef.RangerAccessTypeDef a = new RangerServiceDef.RangerAccessTypeDef("post-notification");
    ...
    public void testPrivate_Checkers_FalseBranches() throws Exception {
        ...
        RangerServiceDef.RangerResourceDef r = new RangerServiceDef.RangerResourceDef();
        r.setName("not-notification-topic");
        List<RangerServiceDef.RangerResourceDef> rList = new ArrayList<>();
        rList.add(r);
        Assertions.assertFalse((Boolean) cr.invoke(patch, rList));

        RangerServiceDef.RangerAccessTypeDef a = new RangerServiceDef.RangerAccessTypeDef("not-post-notification");
        List<RangerServiceDef.RangerAccessTypeDef> aList = new ArrayList<>();
        aList.add(a);
