...
public class TestPublicAPIsv2 {
    ...
    @Test
    public void test1getServiceDef() {
    ...
    @Test
    public void test2getServiceDefByName() {
        RangerServiceDef rangerServiceDef = rangerServiceDef();
    ...
    @Test
    public void test3searchServiceDefs() {
    ...
    @Test
    public void test4createServiceDef() {
        RangerServiceDef rangerServiceDef = rangerServiceDef();
    ...
    @Test
    public void test5updateServiceDef() {
        RangerServiceDef rangerServiceDef = rangerServiceDef();
    ...
    @Test
    public void test6updateServiceDefByName() {
        RangerServiceDef rangerServiceDef = rangerServiceDef();
        String           name             = rangerServiceDef.getName();
        Mockito.when(serviceREST.getServiceDefByName(name)).thenReturn(rangerServiceDef);
        Mockito.when(serviceREST.updateServiceDef(rangerServiceDef, rangerServiceDef.getId())).thenReturn(rangerServiceDef);
    ...
    @Test
    public void test7deleteServiceDef() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
    ...
    @Test
    public void test8deleteServiceDefByName() {
        HttpServletRequest request          = Mockito.mock(HttpServletRequest.class);
        RangerServiceDef   rangerServiceDef = rangerServiceDef();
        String             name             = rangerServiceDef.getName();
        Mockito.when(serviceREST.getServiceDefByName(name)).thenReturn(rangerServiceDef);
    ...
    @Test
    public void test10getServiceByName() {
        RangerService rangerService = rangerService();
    ...
    @Test
    public void test11searchServices() {
        HttpServletRequest  request      = Mockito.mock(HttpServletRequest.class);
        List<RangerService> servicesList = new ArrayList<>();
    ...
    @Test
    public void test12createService() {
        RangerService rangerService = rangerService();
    ...
    @Test
    public void test13updateService() {
        RangerService      rangerService = rangerService();
    ...
    @Test
    public void test14updateServiceByName() {
        RangerService      rangerService = rangerService();
        HttpServletRequest request       = null;
        String             name          = rangerService.getName();
        Mockito.when(serviceREST.getServiceByName(name)).thenReturn(rangerService);
    ...
    @Test
    public void test15deleteService() {
    ...
    @Test
    public void test16deleteServiceByName() {
        RangerService rangerService = rangerService();
        String        name          = rangerService.getName();
        Mockito.when(serviceREST.getServiceByName(name)).thenReturn(rangerService);
    ...
    @Test
    public void test18getPolicyByName() {
        HttpServletRequest request       = Mockito.mock(HttpServletRequest.class);
        RangerPolicy       rangerPolicy  = rangerPolicy();
        RangerService      rangerService = rangerService();
    ...
    @Test
    public void test19searchPolicies() {
        HttpServletRequest request      = Mockito.mock(HttpServletRequest.class);
    ...
    @Test
    public void test20createPolicy() {
        HttpServletRequest request      = Mockito.mock(HttpServletRequest.class);
        RangerPolicy       rangerPolicy = rangerPolicy();
    ...
    @Test
    public void test22updatePolicy() {
        RangerPolicy rangerPolicy = rangerPolicy();
    ...
    @Test
    public void test23updatePolicyByName() {
        HttpServletRequest request       = Mockito.mock(HttpServletRequest.class);
        RangerPolicy       rangerPolicy  = rangerPolicy();
        String             policyName    = rangerPolicy.getName();
        RangerService      rangerService = rangerService();
    ...
    @Test
    public void test24deletePolicy() {
    ...
    @Test
    public void test25deletePolicyByName() {
        HttpServletRequest request       = Mockito.mock(HttpServletRequest.class);
        RangerPolicy       rangerPolicy  = rangerPolicy();
        String             policyName    = rangerPolicy.getName();
        RangerService      rangerService = rangerService();
    ...
    @Test
    public void testGetAllZoneNames() {
        HttpServletRequest                 request            = Mockito.mock(HttpServletRequest.class);
    ...
    @Test
    public void testGetServiceNamesForZone() {
        Long zoneId1           = 2L;
        Long zoneId2           = 3L;
        Long nonExistingZondId = 101L;

        List<RangerServiceHeaderInfo> rangerServiceList1 = new ArrayList<>();
        List<RangerServiceHeaderInfo> rangerServiceList2 = new ArrayList<>();
        ...
        Assert.assertEquals(0, returnedServicesNull.size());
        ...
        Mockito.verify(securityZoneStore, Mockito.times(1)).getServiceHeaderInfoListByZoneId(null, request);
        Assert.assertEquals(0, returnedServicesNonExisting.size());
    ...
    @Test
    public void testGetPolicyByGUIDAndServiceNameAndZoneName() {
        RangerPolicy  rangerPolicy  = rangerPolicy();
        RangerService rangerService = rangerService();
        String        serviceName   = rangerService.getName();
    ...
    @Test
    public void testGetPolicyByGUID() {
        RangerPolicy rangerPolicy = rangerPolicy();
    ...
    @Test
    public void testDeletePolicyByGUIDAndServiceNameAndZoneName() {
        RangerPolicy  rangerPolicy  = rangerPolicy();
        RangerService rangerService = rangerService();
        String        serviceName   = rangerService.getName();
        String        zoneName      = "zone-1";
    ...
    @Test
    public void testDeletePolicyByGUID() {
        RangerPolicy rangerPolicy = rangerPolicy();
