...
public class TestPublicAPIs {
    ...
    @Test
    public void test1getRepository() {
    ...
    @Test
    public void test2createRepository() {
    ...
    @Test
    public void test4deleteRepository() {
    ...
    @Test
    public void test6countRepositories() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
    ...
    @Test
    public void test10deletePolicy() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
    ...
    @Test
    public void test11searchPolicies() {
        HttpServletRequest request    = Mockito.mock(HttpServletRequest.class);
        RangerService      service    = rangerService();
        RangerPolicy       policy     = rangerPolicy();
        ...
        VXPolicy       vXPolicy   = vXPolicy(policy, service);
        List<VXPolicy> vXPolicies = new ArrayList<>();
    ...
    @Test
    public void test12countPolicies() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
