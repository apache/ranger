...
def main(argv):
	...
	get_java_cmd = "%s -Dlogdir=%s -Dlogback.configurationFile=db_patch.log4j.xml -cp %s org.apache.ranger.patch.cliutil.%s"%(JAVA_BIN,ranger_log,path,'UpdateUserAndGroupNamesInJson')
	if os_name == "LINUX":
