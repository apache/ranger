...
class RangerSqoopAuthorizerTest {
     ...
     */
    @Test
    void readConnectorAllWithAllPermissions() {
        String user = SQOOP;
     ...
     */
    @Test
    void readConnectorKafkaWithReadPermission() {
     ...
     */
    @Test
    void readConnectorHdfsWithoutPermission() {
        String user      = ZHANGQIANG;
     ...
     */
    @Test
    void readConnectorOracleJdbcWithAllPermissions() {
        String user      = YUWEN;
     ...
     */
    @Test
    void readConnectorHdfsWithAllPermissions() {
        String user      = YUWEN;
        String connector = HDFS_CONNECTOR;
        AuthorizationEngine.readConnector(user, connector);
    }
     ...
     */
    @Test
    void readConnectorKafkaWithoutPermission() {
        String user      = YUWEN;
        String connector = KAFKA_CONNECTOR;
        assertThrows(SqoopException.class, () -> AuthorizationEngine.readConnector(user, connector));
    }
     ...
     */
    @Test
    void readLinkAnyWithAllPermissions() {
        String user = SQOOP;
     ...
     */
    @Test
    void readLinkOracleWithReadPermission() {
        String user = YUWEN;
     ...
     */
    @Test
    void readLinkHdfsWithReadPermission() {
        String user = YUWEN;
     ...
     */
    @Test
    void readLinkAnyWithoutPermission() {
        String user = YUWEN;
        String link = getRandomLinkName();
     ...
     */
    @Test
    void createLinkByAllConnectorsWithAllPermissions() {
        String user = SQOOP;
        for (String connector : allConnectors) {
     ...
     */
    @Test
    void createLinkByKafkaConnectorWithReadPermission() {
        String user      = ZHANGQIANG;
        String connector = KAFKA_CONNECTOR;
        AuthorizationEngine.createLink(user, connector);
    }
     ...
     */
    @Test
    void createLinkByHdfsConnectorWithoutPermission() {
        String user      = ZHANGQIANG;
        String connector = HDFS_CONNECTOR;
     ...
     */
    @Test
    void createLinkByHdfsConnectorWithReadPermission() {
        String user      = YUWEN;
        String connector = HDFS_CONNECTOR;
        AuthorizationEngine.createLink(user, connector);
    }
     ...
     */
    @Test
    void updateLinkAnyByKafkaConnectorAsCreater() {
        String user      = ZHANGQIANG;
        String connector = KAFKA_CONNECTOR;
        String link      = getRandomLinkName();
        AuthorizationEngine.updateLink(user, connector, link);
     ...
     */
    @Test
    void updateLinkAnyByHdfsConnectorWithoutPermission() {
        String user      = ZHANGQIANG;
        String connector = HDFS_CONNECTOR;
        String link      = getRandomLinkName();
     ...
     */
    @Test
    void deleteLinkAnyWithAllPermissions() {
        String user = SQOOP;
        String link = getRandomLinkName();
     ...
     */
    @Test
    void deleteLinkOracleWithWritePermission() {
        String user = YUWEN;
        String link = ORACLE_LINK;
        AuthorizationEngine.deleteLink(user, link);
    }
     ...
     */
    @Test
    void deleteLinkHdfsWithWritePermission() {
        String user = YUWEN;
        String link = HDFS_LINK;
        AuthorizationEngine.deleteLink(user, link);
    }
     ...
     */
    @Test
    void deleteLinkAnyWithoutPermission() {
        assertThrows(SqoopException.class, () -> {
            String user = YUWEN;
            String link = getRandomLinkName();
            AuthorizationEngine.deleteLink(user, link);
     ...
     */
    @Test
    void enableDisableLinkAnyWithAllPermissions() {
        String user = SQOOP;
        String link = getRandomLinkName();
     ...
     */
    @Test
    void enableDisableLinkAnyAsCreater() {
        String user = ZHANGQIANG;
        String link = getRandomLinkName();
        AuthorizationEngine.enableDisableLink(user, link);
    }
     ...
     */
    @Test
    void enableDisableLinkOracleWithWritePermission() {
        String user = YUWEN;
        String link = ORACLE_LINK;
        AuthorizationEngine.enableDisableLink(user, link);
    }
     ...
     */
    @Test
    void readJobAnyWithAllPermissions() {
        String user = SQOOP;
     ...
     */
    @Test
    void readJobAnyWithoutPermission() {
        assertThrows(SqoopException.class, () -> {
            String user = YUWEN;
            String job  = getRandomJobName();
            AuthorizationEngine.readJob(user, job);
     ...
     */
    @Test
    void createJobByAnyTwoLinksWithAllPermissions() {
        String user  = SQOOP;
     ...
     */
    @Test
    void createJobByAnyTwoLinksAsCreater() {
        String user  = ZHANGQIANG;
        String link1 = getRandomLinkName();
        String link2 = getRandomLinkName();
        AuthorizationEngine.createJob(user, link1, link2);
     ...
     */
    @Test
    void createJobFromOracle2AnyLinkWithoutPermission() {
        assertThrows(SqoopException.class, () -> {
            String user  = YUWEN;
            String link1 = ORACLE_LINK;
            String link2 = getRandomLinkName();
     ...
     */
    @Test
    void updateJobAnyByAnyTwoLinksWithAllPermissions() {
        String user  = SQOOP;
        String link1 = getRandomLinkName();
        String link2 = getRandomLinkName();
        String job   = getRandomJobName();
     ...
     */
    @Test
    void deleteJobAnyWithAllPermissions() {
        String user = SQOOP;
        String job  = getRandomJobName();
     ...
     */
    @Test
    void deleteJobOracle2HdfsWithWritePermission() {
        String user = YUWEN;
        String job  = ORACLE2HDFS_JOB;
        AuthorizationEngine.deleteJob(user, job);
    }
     ...
     */
    @Test
    void deleteJobAnyWithoutPermission() {
        assertThrows(SqoopException.class, () -> {
            String user = YUWEN;
            String job  = getRandomJobName();
            AuthorizationEngine.deleteJob(user, job);
     ...
     */
    @Test
    void enableDisableJobAnyAsCreater() {
        String user = ZHANGQIANG;
        String job  = getRandomJobName();
        AuthorizationEngine.enableDisableJob(user, job);
    }
     ...
     */
    @Test
    void enableDisableJobOracle2HdfsWithWritePermission() {
        String user = YUWEN;
        String job  = ORACLE2HDFS_JOB;
        AuthorizationEngine.enableDisableJob(user, job);
    }
     ...
     */
    @Test
    void startJobAnyWithAllPermissions() {
        String user = SQOOP;
        String job  = getRandomJobName();
     ...
     */
    @Test
    void startJobOracle2HdfsWithWritePermission() {
        String user = YUWEN;
        String job  = ORACLE2HDFS_JOB;
        AuthorizationEngine.startJob(user, job);
    }
     ...
     */
    @Test
    void startJobAnyWithoutPermission() {
        assertThrows(SqoopException.class, () -> {
            String user = YUWEN;
            String job  = getRandomJobName();
            AuthorizationEngine.startJob(user, job);
     ...
     */
    @Test
    void stopJobAnyWithAllPermissions() {
        String user = SQOOP;
        String job  = getRandomJobName();
     ...
     */
    @Test
    void stopJobAnyWithoutPermission() {
        assertThrows(SqoopException.class, () -> {
            String user = YUWEN;
            String job  = getRandomJobName();
            AuthorizationEngine.stopJob(user, job);
     ...
     */
    @Test
    void statusJobOracle2HdfsWithReadPermission() {
        String user = YUWEN;
        String job  = ORACLE2HDFS_JOB;
        AuthorizationEngine.statusJob(user, job);
    }
     ...
     */
    @Test
    void statusJobAnyWithoutPermission() {
        assertThrows(SqoopException.class, () -> {
            String user = YUWEN;
            String job  = getRandomJobName();
            AuthorizationEngine.statusJob(user, job);
    ...
    /**
     * Verifies empty privilege collections short-circuit before policy evaluation.
     */
    @Test
    void rangerAuthorizerCheckPrivilegesWithEmptyPrivilegeCollectionReturnsImmediately() {
        RangerSqoopAuthorizer authorizer = new RangerSqoopAuthorizer();
        authorizer.checkPrivileges(mock(MPrincipal.class), Collections.emptyList());
    }

    /**
     * Verifies null privilege collections are treated as empty input.
     */
    @Test
    void rangerAuthorizerCheckPrivilegesWithNullPrivilegeCollectionReturnsImmediately() {
        RangerSqoopAuthorizer authorizer = new RangerSqoopAuthorizer();
        authorizer.checkPrivileges(mock(MPrincipal.class), null);
    }
}
