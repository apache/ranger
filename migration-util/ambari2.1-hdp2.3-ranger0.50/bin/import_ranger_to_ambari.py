...
def add_advanced_ranger_configurations(add_admin_or_usersync, ranger_service_properties_from_file):
	...
	if (add_admin_or_usersync == 1):
		if not ((str(ranger_service_properties_from_file['db_root_password']).strip() == '') or
			...
			advanced_ranger_admin_site_properties['ranger.audit.elasticsearch.urls'] = ranger_service_properties_from_file.get('ranger.audit.elasticsearch.urls','http://elasticsearch_host:9200/')
			advanced_ranger_admin_site_properties['ranger.audit.elasticsearch.user'] = ranger_service_properties_from_file.get('ranger.audit.elasticsearch.user','')
			advanced_ranger_admin_site_properties['ranger.audit.elasticsearch.password'] = ranger_service_properties_from_file.get('ranger.audit.elasticsearch.password','')
...
def add_advanced_ranger_kms_configurations(ranger_kms_properties_from_file):
	...
	advanced_ranger_kms_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = ranger_kms_properties_from_file.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
	advanced_ranger_kms_audit_properties['xasecure.audit.destination.elasticsearch.user'] = ranger_kms_properties_from_file.get('xasecure.audit.destination.elasticsearch.user','')
	advanced_ranger_kms_audit_properties['xasecure.audit.destination.elasticsearch.password'] = ranger_kms_properties_from_file.get('xasecure.audit.destination.elasticsearch.password','')
...
def port_ranger_hdfs_plugin_to_ambari():
	...
	if flag_hdfs_plugin_installed and hdfs_plugin_install_properties is not None and hdfs_site_xml_properties is not None:
		...
		advanced_ranger_hdfs_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = hdfs_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_hdfs_audit_properties['xasecure.audit.destination.elasticsearch.user'] = hdfs_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.user','')
		advanced_ranger_hdfs_audit_properties['xasecure.audit.destination.elasticsearch.password'] = hdfs_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.password','')
...
def port_ranger_yarn_plugin_to_ambari():
	...
	if( flag_yarn_plugin_installed and yarn_plugin_installed_properties is not None and yarn_site_xml_properties is not None):
		...
		advanced_ranger_yarn_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = yarn_plugin_installed_properties.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_yarn_audit_properties['xasecure.audit.destination.elasticsearch.user'] = yarn_plugin_installed_properties.get('xasecure.audit.destination.elasticsearch.user','')
		advanced_ranger_yarn_audit_properties['xasecure.audit.destination.elasticsearch.password'] = yarn_plugin_installed_properties.get('xasecure.audit.destination.elasticsearch.password','')
...
# 		advanced_ranger_hive_plugin_properties['ranger-hive-plugin-enabled'] = 'Yes'
		...
		advanced_ranger_hive_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = hive_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_hive_audit_properties['xasecure.audit.destination.elasticsearch.user'] = hive_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.user','')
		advanced_ranger_hive_audit_properties['xasecure.audit.destination.elasticsearch.password'] = hive_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.password','')
...
def port_ranger_hbase_plugin_to_ambari():
	...
	if flag_hbase_plugin_installed and hbase_plugin_install_properties is not None and hbase_site_xml_properties is not None:
		...
		advanced_ranger_hbase_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = hbase_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_hbase_audit_properties['xasecure.audit.destination.elasticsearch.user'] = hbase_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.user','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_hbase_audit_properties['xasecure.audit.destination.elasticsearch.password'] = hbase_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.password','{{ranger_audit_elasticsearch_urls}}')
...
def port_ranger_knox_plugin_to_ambari():
	...
	if flag_knox_plugin_installed and knox_plugin_install_properties is not None:
		...
		advanced_ranger_knox_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = knox_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_knox_audit_properties['xasecure.audit.destination.elasticsearch.user'] = knox_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.user','')
		advanced_ranger_knox_audit_properties['xasecure.audit.destination.elasticsearch.password'] = knox_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.password','')
...
def port_ranger_storm_plugin_to_ambari():
	...
	if flag_storm_plugin_installed and storm_plugin_install_properties is not None:
		...
		advanced_ranger_storm_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = storm_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_storm_audit_properties['xasecure.audit.destination.elasticsearch.user'] = storm_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.user','')
		advanced_ranger_storm_audit_properties['xasecure.audit.destination.elasticsearch.password'] = storm_plugin_install_properties.get('xasecure.audit.destination.elasticsearch.password','')
...
def port_ranger_kafka_plugin_to_ambari():
	...
	if flag_kafka_plugin_installed and kafka_plugin_installed_properties is not None:
		...
		advanced_ranger_kafka_audit_properties['xasecure.audit.destination.elasticsearch.urls'] = kafka_plugin_installed_properties.get('xasecure.audit.destination.elasticsearch.urls','{{ranger_audit_elasticsearch_urls}}')
		advanced_ranger_kafka_audit_properties['xasecure.audit.destination.elasticsearch.user'] = kafka_plugin_installed_properties.get('xasecure.audit.destination.elasticsearch.user','')
		advanced_ranger_kafka_audit_properties['xasecure.audit.destination.elasticsearch.password'] = kafka_plugin_installed_properties.get('xasecure.audit.destination.elasticsearch.password','')
