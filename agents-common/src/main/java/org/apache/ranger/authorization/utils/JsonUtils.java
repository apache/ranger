...
public class JsonUtils {
    ...
    private static final TypeReference<Map<String, RangerPolicyItemDataMaskInfo>> TYPE_MAP_RANGER_MASK_INFO            = new TypeReference<Map<String, RangerPolicyItemDataMaskInfo>>() {};
