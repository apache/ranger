...
public class RangerAuditMetricsByDays extends RangerBaseModelObject implements java.io.Serializable {
     ...
     */
    public RangerAuditMetricsByDays(String serviceType, String serviceName, String appId, String clusterName, String clientIP, Long auditDate, Long numberOfAudits) {
        super();
