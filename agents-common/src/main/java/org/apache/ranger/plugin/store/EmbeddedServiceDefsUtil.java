...
public class EmbeddedServiceDefsUtil {
    ...
    public static final String DEFAULT_BOOTSTRAP_SERVICEDEF_LIST        = "tag,gds,hdfs,hbase,hive,kms,knox,storm,yarn,kafka,solr,atlas,nifi,nifi-registry,sqoop,kylin,elasticsearch,presto,trino,ozone,kudu,schema-registry,nestedstructure,seatunnel";
    ...
    public static final String EMBEDDED_SERVICEDEF_SEATUNNEL_NAME  = "seatunnel";
    ...
    public static final String SETUNNEL_IMPL_CLASS_NAME  = "org.apache.ranger.services.seatunnel.RangerServiceSeatunnel";
    ...
    private RangerServiceDef seatunnelServiceDef;
    ...
    public void init(ServiceStore store) {
        ...
        try {
            ...
            seatunnelServiceDef = getOrCreateServiceDef(store, EMBEDDED_SERVICEDEF_SEATUNNEL_NAME);
    ...
    public long getSeatunnelServiceDefId() {
        return getId(seatunnelServiceDef);
    }
