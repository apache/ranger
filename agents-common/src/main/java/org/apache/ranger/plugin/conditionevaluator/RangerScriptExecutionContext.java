...
public final class RangerScriptExecutionContext {
	...
	public final RangerResource.RangerResourceTag getCurrentTag() {
		@SuppressWarnings("unchecked")
		RangerResource.RangerResourceTag tagObject = (RangerResource.RangerResourceTag)getEvaluationContext()
	...
	public final String getCurrentTagName() {
		RangerResource.RangerResourceTag tagObject = getCurrentTag();
	...
	public final Set<String> getAllTagNames() {
		...
		List<RangerResource.RangerResourceTag> tagObjectList = getAllTags();

		if (CollectionUtils.isNotEmpty(tagObjectList)) {

			for (RangerResource.RangerResourceTag tag : tagObjectList) {
	...
	public final String getAttributeValue(final String attributeName) {
		...
		if (StringUtils.isNotBlank(attributeName)) {
			RangerResource.RangerResourceTag tag = getCurrentTag();
	...
	private List<RangerResource.RangerResourceTag> getAllTags() {
		...
		@SuppressWarnings("unchecked")
		List<RangerResource.RangerResourceTag> ret = (List<RangerResource.RangerResourceTag>)getEvaluationContext().get(RangerPolicyEngine.KEY_CONTEXT_TAGS);
