    ...
    private Predicate addPredicateForServiceId(final String serviceId, List<Predicate> predicates) {
        ...
        Predicate ret = object -> {
            ...
            if (object instanceof RangerPolicy) {
                ...
                if (svcId != null) {
                    ret1 = StringUtils.equals(serviceId, svcId.toString());
                }
            } else if (object instanceof RangerService) {
                RangerService service = (RangerService) object;

                if (service.getId() != null) {
                    ret1 = StringUtils.equals(serviceId, service.getId().toString());
                }
            } else {
                ret1 = true;
            }
        ...
        Predicate ret = object -> {
            ...
            if (object instanceof RangerService) {
                ...
                if (!StringUtils.isEmpty(service.getTagService())) {
                    ...
                    ret1 = tagService != null && tagService.getId() != null && StringUtils.equals(tagServiceId, tagService.getId().toString());
                }
            } else {
                ret1 = true;
            }
