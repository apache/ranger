...
public class RangerDefaultPolicyEvaluatorTest {
    ...
    RangerPolicyItem getMockPolicyItem(String[] strings) {
        ...
        if (strings == null) {
            ...
            when(policyItem.getConditions()).thenReturn(new ArrayList<>());
        } else {
            List<RangerPolicyItemCondition> conditions = new ArrayList<>(strings.length);
    ...
    RangerPolicyItem createPolicyItemForConditions(String[] conditions) {
        List<RangerPolicyItemCondition> itemConditions = new ArrayList<>(conditions.length);
    ...
    RangerAccessRequest createAccessRequestWithConditions(String[] conditionNames) {
        ...
        Map<String, Object> context = new HashMap<>(conditionNames.length);
