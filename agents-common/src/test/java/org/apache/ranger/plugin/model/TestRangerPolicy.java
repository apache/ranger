...
public class TestRangerPolicy {
    ...
    @Test
    public void test05_DefaultsAndPriorityAuditFlags() {
    ...
    @Test
    public void test06_PolicyResourceEqualsHashCodeAndFlags() {
    ...
    @Test
    public void test07_PolicyItemAddRemoveApisAndEquals() {
    ...
    @Test
    public void test08_DataMaskAndRowFilterItems() {
    ...
    @Test
    public void test09_PolicySettersAndNullSafeSupplierV2() {
        RangerPolicy p = new RangerPolicy();
    ...
    @Test
    public void test10_AdditionalResourcesAndToString() {
        RangerPolicy p = new RangerPolicy();
    ...
    @Test
    public void test11_PolicyIdComparator() {
    ...
    @Test
    public void test12_NestedEqualsNullPaths() {
