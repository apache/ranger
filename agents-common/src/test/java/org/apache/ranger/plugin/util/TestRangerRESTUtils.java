...
public class TestRangerRESTUtils {
    ...
    public void test03_hostnameAndAppIdParsing() {
        RangerRESTUtils utils = new RangerRESTUtils();
        String hostname = utils.getAgentHostname();
        assertNotNull(hostname);

        String service = "service";
        String pluginId = "app@" + hostname + "-" + service;
        assertEquals(hostname, utils.getHostnameFromPluginId(pluginId, service));
        assertEquals(hostname, utils.getHostnameFromPluginId(hostname + "-" + service, service));
        assertEquals(hostname, utils.getHostnameFromPluginId(hostname + "-abc", null));
