...
public class TestRangerPolicyResourceSignature {
    ...
    public void test_getResourceSignature_happyPath() {
        ...
        Assertions.assertEquals("", serializer.toString(), "Null policy");

        policy = mock(RangerPolicy.class);
        when(policy.getPolicyType()).thenReturn(null);
        Map<String, RangerPolicyResource> policyResources = utils.createPolicyResourceMap(first);
        ...
        policyResources = utils.createPolicyResourceMap(dataSecond);
        when(policy.getResources()).thenReturn(policyResources);
        Assertions.assertEquals(expectedFull, serializer.toString());
    ...
    public void test_nullRecursiveFlagIsSameAsFlase() {
        ...
        RangerPolicy                  policy2    = createPolicy(firstRecursiveNullOrFalse);
    ...
    public void test_onlyDifferByRecursiveFlag() {
        ...
        RangerPolicy policy1 = createPolicy(first);
        RangerPolicy policy2 = createPolicy(firstRecursiveFlagDifferent);
        when(policy1.getGuid()).thenReturn("TEST_GUID-1");
        when(policy2.getGuid()).thenReturn("TEST_GUID-2");
        RangerPolicyResourceSignature signature1 = new RangerPolicyResourceSignature(policy1);
        RangerPolicyResourceSignature signature2 = new RangerPolicyResourceSignature(policy2);
        Assertions.assertNotEquals(signature1.toString(), signature2.toString(), "Resources differ only by recursive flag true vs false/null");
    }
    ...
    public void test_nullExcludesFlagIsSameAsFlase() {
        ...
        RangerPolicy policy1 = createPolicy(first);
        RangerPolicy policy2 = createPolicy(firstExcludesNullOrFalse);
        when(policy1.getGuid()).thenReturn("TEST_GUID-1");
        when(policy2.getGuid()).thenReturn("TEST_GUID-2");
        RangerPolicyResourceSignature signature1 = new RangerPolicyResourceSignature(policy1);
        RangerPolicyResourceSignature signature2 = new RangerPolicyResourceSignature(policy2);
    ...
    public void test_onlyDifferByExcludesFlag() {
        ...
        RangerPolicy policy1 = createPolicy(first);
        RangerPolicy policy2 = createPolicy(firstExcludesFlagDifferent);
        when(policy1.getGuid()).thenReturn("TEST_GUID-1");
        when(policy2.getGuid()).thenReturn("TEST_GUID-2");
        RangerPolicyResourceSignature signature1 = new RangerPolicyResourceSignature(policy1);
        RangerPolicyResourceSignature signature2 = new RangerPolicyResourceSignature(policy2);
        Assertions.assertNotEquals(signature1.toString(), signature2.toString(), "Resources differ only by excludes flag true vs false/null");
    }
    ...
    public void test_integration() {
        ...
        Map<String, RangerPolicyResource> resources = utils.createPolicyResourceMap(first);
        ...
        resources = utils.createPolicyResourceMap(dataSecond);
        ...
        Assertions.assertEquals(signature, anotherSignature);
        Assertions.assertEquals(anotherSignature, signature);
    }
    ...
    RangerPolicy createPolicy(Object[][] data) {
        ...
        Map<String, RangerPolicyResource> resources = utils.createPolicyResourceMap(data);
