...
/**
* @generated by Cursor
* @description <Unit Test for RangerPolicyResourceSignature class>
*/
...
public class TestRangerPolicyResourceSignature {
    ...
    @Test
    public void test02_isPolicyValidForResourceSignatureComputation() {
    ...
    @Test
    public void test03_RangerPolicyResourceSignature() {
    ...
    @Test
    public void test04_getResourceSignature_happyPath() {
    ...
    @Test
    public void test05_nullRecursiveFlagIsSameAsFlase() {
    ...
    @Test
    public void test06_onlyDifferByRecursiveFlag() {
    ...
    @Test
    public void test07_nullExcludesFlagIsSameAsFlase() {
    ...
    @Test
    public void test08_onlyDifferByExcludesFlag() {
    ...
    @Test
    public void test09_integration() {
