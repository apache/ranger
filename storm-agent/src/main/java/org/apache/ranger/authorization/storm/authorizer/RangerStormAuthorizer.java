    ...
    public boolean permit(ReqContext aRequestContext, String aOperationName, Map aTopologyConfigMap) {
        ...
        try {
            ...
            if (noAuthzOperations.contains(aOperationName)) {
                ...
                LOG.info("Ranger plugin not initialized yet! Skipping authorization;  allowedFlag => [{}], Audit Enabled:{}", accessAllowed, isAuditEnabled);
            } else {
                ...
                if (userName != null) {
                    ...
                    LOG.info("NULL User found from principal [{}]: Skipping authorization;  allowedFlag => [{}], Audit Enabled:{}", user, accessAllowed, isAuditEnabled);
                }
            }
        } catch (Throwable t) {
