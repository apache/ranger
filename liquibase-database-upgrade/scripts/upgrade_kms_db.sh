...
${JAVA_HOME}/bin/java -Dlog4j.configurationFile=file:${LOG4J_PROPERTIES_FILE_PATH} -cp "${cp}" org.apache.ranger.db.upgrade.LiquibaseUpdateDriverMain -serviceName ${1} -op ${2} -tag ${3}