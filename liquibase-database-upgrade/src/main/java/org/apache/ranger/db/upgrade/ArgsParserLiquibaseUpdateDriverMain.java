...
class ArgsParserLiquibaseUpdateDriverMain {
    ...
    @Parameter(names = "-op", description = "The operation to do on the cluster (e.g. update/rollback/finalize)", validateWith = SupportedOps.class)
    ...
    public static class SupportedOps implements IParameterValidator {
        ...
        public void validate(String name, String value) throws ParameterException {
            ...
            if (!validOps.contains(value)) {
                throw new ParameterException(value + " is not a supported operation");
            }
        }
    }
}
