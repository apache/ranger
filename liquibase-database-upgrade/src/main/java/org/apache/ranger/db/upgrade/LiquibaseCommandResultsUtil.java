    ...
    public static boolean isUpdateSuccessful(CommandResults updateResult) {
        ...
        */
        ...
        if (operationInfoObj instanceof OperationInfo) {
            operationInfoResult = "success".equals(((OperationInfo) operationInfoObj).getOperationOutcome());
        }
        ...
        if (updateReportObj instanceof UpdateReportParameters) {
            updateReportResult = Boolean.TRUE.equals(((UpdateReportParameters) updateReportObj).getSuccess());
        }
