...
import org.apache.ranger.audit.consumer.HdfsConsumerManager;
...
/**
 * Health check REST endpoint for HDFS Consumer Service
 */
@Path("/health")
@Component
@Scope("request")
public class HealthCheckREST {
    ...
    HdfsConsumerManager hdfsConsumerManager;
    ...
    public Response healthCheck() {
        ...
        try {
            ...
            if (hdfsConsumerManager != null) {
                Map<String, Object> resp = new HashMap<>();
                resp.put("status", "UP");
                resp.put("service", "audit-consumer-hdfs");
                ...
                resp.put("service", "audit-consumer-hdfs");
                resp.put("reason", "HdfsConsumerManager not available");
                resp.put("timestamp", System.currentTimeMillis());
                jsonString = buildResponse(resp);
