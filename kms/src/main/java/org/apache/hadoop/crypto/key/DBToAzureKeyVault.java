...
public class DBToAzureKeyVault {
    ...
    public static void main(String[] args) {
        if (args.length < 7) {
            ...
            result = new DBToAzureKeyVault().doExportMKToAzureKeyVault(sslEnabled, azureKeyName, azureMasterKeyType,
                    zoneKeyEncryptionAlgo, azureClientId, azureKeyVaultUrl, passwordOrCertPath, certificatePassword, conf);
            if (result) {
