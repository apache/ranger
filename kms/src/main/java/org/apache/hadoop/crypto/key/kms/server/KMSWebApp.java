...
public class KMSWebApp implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            log.info("URI = {} scheme = {}", new URI(providerString).toString(), new URI(providerString).getScheme());
            ...
            Preconditions.checkNotNull(keyProvider, String.format("No KeyProvider has been initialized, please" +
                            " check whether %s '%s' is configured correctly in kms-site.xml.", KMSConfiguration.KEY_PROVIDER_URI, providerString));
