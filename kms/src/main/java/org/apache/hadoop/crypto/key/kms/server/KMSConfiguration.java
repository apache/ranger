...
public class KMSConfiguration {
    ...
    public static final String KEY_PROVIDER_URI             = CONFIG_PREFIX + "key.provider.uri"; // Property to set the backing KeyProvider
    public static final String KEY_CACHE_ENABLE             = CONFIG_PREFIX + "cache.enable"; // Property to Enable/Disable Caching
    public static final String KEY_CACHE_TIMEOUT_KEY        = CONFIG_PREFIX + "cache.timeout.ms"; // Timeout for the Key and Metadata Cache
    public static final String CURR_KEY_CACHE_TIMEOUT_KEY   = CONFIG_PREFIX + "current.key.cache.timeout.ms"; // TImeout for the Current Key cache
    public static final String KMS_AUDIT_AGGREGATION_WINDOW = CONFIG_PREFIX + "audit.aggregation.window.ms"; // Delay for Audit logs that need aggregation
    public static final String KMS_AUDIT_LOGGER_KEY         = CONFIG_PREFIX + "audit.logger"; //KMS Audit logger classes to use
    public static final String KMS_SECURITY_AUTHORIZER      = CONFIG_PREFIX + "security.authorization.manager"; //for authorizer
    public static final String KEY_AUTHORIZATION_ENABLE     = CONFIG_PREFIX + "key.authorization.enable"; // Property to Enable/Disable per Key authorization
    ...
    public static final long    KEY_CACHE_TIMEOUT_DEFAULT            = 10 * 60 * 1000; // 10 mins
    public static final long    CURR_KEY_CACHE_TIMEOUT_DEFAULT       = 30 * 1000; // 30 secs
    public static final long    KMS_AUDIT_AGGREGATION_WINDOW_DEFAULT = 10000; // 10 secs
    ...
    public static boolean isACLsFileNewer(long time) {
        ...
        if (confDir != null) {
            ...
            // at least 100ms newer than time, we do this to ensure the file has been properly closed/flushed
